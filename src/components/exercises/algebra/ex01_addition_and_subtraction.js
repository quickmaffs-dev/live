...
import {additionAndSubtraction} from './algebra_exercises';

class ex01_addition_and_subtraction extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
...
export default ex01_addition_and_subtraction;