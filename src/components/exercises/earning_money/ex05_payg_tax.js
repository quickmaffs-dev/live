...
import {calculatePAYGtax} from './earning_money_exercises';

class ex05_payg_tax extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    componentDidMount(){
        ...
        document.querySelectorAll(".topicSubHeading")[0].innerHTML = "This will ask questions on PAYG tax. Click the Start button below to begin...";            
    ...
    makeQuestion = () => { 
        ...
        for (let i = 0; i < document.querySelectorAll(".mcAnsBtn").length; i++) {            
            document.querySelectorAll(".mcAnsBtn")[i].onclick = () => {checkAns(correctAns, document.querySelectorAll(".mcAnsBtn")[i].innerHTML, this.question_string, "earning money ex05")};            
        }
