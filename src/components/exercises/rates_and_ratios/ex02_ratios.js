...
import {simplifyRatioDuo, simplifyRatioTrio, ratioApplications} from './rates_and_ratios_exercises';
...
class ex02_ratios extends React.Component {
    ...
    makeQuestion = () => { 
        ...
        if (chooseQuestion === 1) {
            result = simplifyRatioDuo();
        } else if (chooseQuestion === 2) {
            result = simplifyRatioTrio();
        } else if (chooseQuestion === 3) {
            result = ratioApplications();
        } else {
