...
import {equationProblems} from './equations_exercises';

class ex02_equation_problems extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    componentDidMount(){
        ...
        document.querySelectorAll(".topicSubHeading")[0].innerHTML = "This will ask to solve equation problems. Click the Start button below to begin...";
    ...
    makeQuestion = () => { 
        ...
        document.getElementById("userInputBtnID").onclick = () => {checkUserInputAns(correctAns, document.getElementById("userInputStringID").value, this.question_string, "equations ex02")};
...
export default ex02_equation_problems;