...
import {findIntercepts, findValues} from './coordinate_geometry_exercises';

class ex05_cartesian_points extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    makeQuestion = () => { 
        ...
        for (let i = 0; i < document.querySelectorAll(".mcAnsBtn").length; i++) {            
            document.querySelectorAll(".mcAnsBtn")[i].onclick = () => {checkAns(correctAns, document.querySelectorAll(".mcAnsBtn")[i].innerHTML, this.question_string, "coordinate geometry ex05")};
        }
        this.writeFormula();
        this.writeExample();
    }
...
export default ex05_cartesian_points;