...
class ex02_zscores extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    makeQuestion = () => { 
        ...
        for (let i = 0; i < document.querySelectorAll(".mcAnsBtn").length; i++) {            
            document.querySelectorAll(".mcAnsBtn")[i].onclick = () => {checkAns(correctAns, document.querySelectorAll(".mcAnsBtn")[i].innerHTML, this.question_string, "normal distribution ex02")};
        }
        this.writeFormula();
        this.writeExample();
    }
    ...
    zScores = () => {
        ...
        this.Ans = ans.toFixed(4);
        this.mc1 = (ans + getRandomNumber(1, 999, 0, 1) / 10000).toFixed(4);
        this.mc2 = (ans + getRandomNumber(1, 999, 0, 1) / 10000).toFixed(4);
        this.mc3 = (ans + getRandomNumber(1, 999, 0, 1) / 10000).toFixed(4);
