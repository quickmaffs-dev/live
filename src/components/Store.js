...
const Store = () => {
    ...
    async function checkIfUserIsLoggedIn() {
        ...
        if (user_id !== null) {
            ...
            if (document.getElementsByClassName("classList spinner loading items")[0]) {
                document.getElementsByClassName("classList spinner loading items")[0].style.display = "block";
            }
            if (document.getElementsByClassName("classList spinner loading slot")[0]) {
                document.getElementsByClassName("classList spinner loading slot")[0].style.display = "block";
            }
            if (document.getElementsByClassName("classList spinner loading market")[0]) {
                document.getElementsByClassName("classList spinner loading market")[0].style.display = "block";
            }

            await dressUser("hat", hat.item_id);
            await dressUser("shirt", shirt.item_id);            
        ...
        if (id > 0) {
            ...
            for (let i = 0; i < n.length; i++) {
                if (n[i].id === "userAvatar_" + c) {
                    if (document.getElementById("userAvatar_" + c)) {
    ...
    async function showMyItems() {            
        ...
        // turn off spinner loader
        if (document.getElementsByClassName("classList spinner loading items")[0]) {
            document.getElementsByClassName("classList spinner loading items")[0].style.display = "none";
        }
    ...
    async function myItemsBtnsActivate() {
        ...
        for (let i = 0; i < equipBtn.length; i++) {
            equipBtn[i].onclick = async function(){
                ...
                await dressUser(p.class, p.item_id);
            }
        }
    ...
    function openSlots() {
        // turn off spinner loader
        if (document.getElementsByClassName("classList spinner loading slot")[0]) {
            document.getElementsByClassName("classList spinner loading slot")[0].style.display = "none";
        }
    ...
    async function spinSlot() {
        if (usersPoints >= packCost) {
            ...
            if (document.getElementsByClassName("slotMachine")[0]) {
                document.getElementsByClassName("slotMachine")[0].style.display = "block";
                let m = document.getElementsByClassName("slot");        
                if (products.length > 0) {
                    let packItems = [];
    ...
    async function openMarket() {     
        ...
        // turn off spinner loader
        if (document.getElementsByClassName("classList spinner loading market")[0]) {
            document.getElementsByClassName("classList spinner loading market")[0].style.display = "none";
        }
    ...
    return (
        <div className="Store">
            ...
            <div className="userInfo" style={{display:"none"}}>
                <p id="userID"></p>
                <h3>Your Avatar:</h3>
                <p className="storeDesc">This is your avatar which will be seen in the Live Battle and Royale multiplayer modes. Here you can customise the appearance of your avatar.</p>
            ...
            <div className="myItems" style={{display:"none"}}>
                <h3>My Items</h3>
                <p className="storeDesc">These are the items you have won from the slot machine or have purchased from the marketplace. Here you can equip items for your avatar or list unwanted items in the marketplace.</p>
                <div className="classList spinner loading items"></div>
                <div className="itemList"></div>
            </div>
            <br /><br />
            <div className="pack" style={{display:"none"}}>
                <h3>Slot Machine</h3>
                <p className="storeDesc">The slot machine randomly selects 3 items to be used to customise your avatar.</p>
                <div className="classList spinner loading slot"></div>
                <br />
            ...
            <div className="marketplace" style={{display:"none"}}>
                <h3>Marketplace</h3>
                <p className="storeDesc">These are items other users have listed. Here you can purchase these items from other users or list your own items.</p>
                <div className="classList spinner loading market"></div>
