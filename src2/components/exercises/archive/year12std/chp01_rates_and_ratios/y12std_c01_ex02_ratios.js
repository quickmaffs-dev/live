...
import {getRandomNumber, printTest, shuffle, reset, answerType, checkAns, getPrimeFactors, getNames} from '../../MathFunctions';
import Workspace from '../../../Workspace';

class y12std_c01_ex02_ratios extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
...
export default y12std_c01_ex02_ratios;