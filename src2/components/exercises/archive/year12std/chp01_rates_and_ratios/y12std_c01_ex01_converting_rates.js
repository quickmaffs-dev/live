...
class y12std_c01_ex01_converting_rates extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    convertRatesSingle = () => {
        ...
        if (getRandomNumber(1, 2, 0, 0) === 1) {
            // large : small
            let questionText = "Convert " + b + " to " + prefixes[pn0] + unit;
            this.Ans = a;
            ...
            let questionText = "Convert " + a + " to " + prefixes[pn2] + unit;
            this.Ans = b;
    ...
    convertRatesDouble = () => {
        ...
        if (getRandomNumber(1, 2, 0, 0) === 1) {      
            ...
            let questionText = "Convert " + numberWithCommas(b) + x2 + "/" + y2 + " to " + x1 + "/" + y1;
            ...
            let questionText = "Convert " + numberWithCommas(a) + x1 + "/" + y1 + " to " + x2 + "/" + y2;
...
export default y12std_c01_ex01_converting_rates;