...
const Royale = () => {
    ...
    async function beginRoyale() {
        ...
        if (loadingScreen === 1) await printLoadingScreen();
        loadingScreen = 0;
    ...
    function playerTableNames() {
        for (let i = 0; i < maxRoyalePlayers; i++) {
            document.getElementsByClassName("playerTile")[i].innerHTML = playerTable[i];
        }
    }
    ...
    async function gameOver() {
        ...
        console.log("winner is " + document.getElementsByClassName("playerTile")[winner].innerHTML);
        document.getElementsByClassName("questionSpace")[0].style.transition = "all 3s";
        document.getElementsByClassName("questionSpace")[0].style.opacity = "0";
        setTimeout(function() {document.getElementsByClassName("questionSpace")[0].style.display = "none";}, 3000);
        await sleep(3000);
    ...
    async function showPodium() {        
        ...
        await sleep(500);
        document.getElementsByClassName("winner")[2].innerHTML += document.getElementsByClassName("playerTile")[podium[2]].innerHTML;

        await sleep(750);
        document.getElementsByClassName("winner")[1].innerHTML += document.getElementsByClassName("playerTile")[podium[1]].innerHTML

        await sleep(1000);
        document.getElementsByClassName("winner")[0].innerHTML += document.getElementsByClassName("playerTile")[podium[0]].innerHTML
    }
