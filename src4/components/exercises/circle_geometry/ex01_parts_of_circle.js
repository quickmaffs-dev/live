...
import {partsOfCircle} from './circle_geometry_exercises';

class ex01_parts_of_circle extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    makeQuestion = () => { 
        ...
        for (let i = 0; i < document.querySelectorAll(".mcAnsBtn").length; i++) {            
            document.querySelectorAll(".mcAnsBtn")[i].onclick = () => {checkAns(correctAns, document.querySelectorAll(".mcAnsBtn")[i].innerHTML, this.question_string, "circle geometry ex01")};
        }
        this.writeFormula();
        this.writeExample();
    }
...
export default ex01_parts_of_circle;