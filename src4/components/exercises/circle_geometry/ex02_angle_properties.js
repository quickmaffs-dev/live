...
import {angleProperties} from './circle_geometry_exercises';

class ex02_angle_properties extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    componentDidMount(){
        document.querySelectorAll(".topicHeading")[0].innerHTML = "Circle Geometry";
        document.querySelectorAll(".topicSubHeading")[0].innerHTML = "This will ask quesitons regarding circle geometry. Click the Start button below to begin...";
    ...
    makeQuestion = () => {
        ...
        for (let i = 0; i < document.querySelectorAll(".mcAnsBtn").length; i++) {            
            document.querySelectorAll(".mcAnsBtn")[i].onclick = () => {checkAns(correctAns, document.querySelectorAll(".mcAnsBtn")[i].innerHTML, this.question_string, "circle geometry ex02")};
        }
        this.writeFormula();
        this.writeExample();
    }
...
export default ex02_angle_properties;