...
import {getRandomNumber, printTest, shuffle, reset, answerType, checkAns, getYearUrl} from '../MathFunctions';
...
class ex01_converting_rates extends React.Component {
    ...
    makeQuestion = () => { 
        ...
        let yearUrl = getYearUrl();
        if (yearUrl === "9") {
            chooseQuestion = getRandomNumber(1, 2, 0, 0);
        }
        if (chooseQuestion === 1) {
