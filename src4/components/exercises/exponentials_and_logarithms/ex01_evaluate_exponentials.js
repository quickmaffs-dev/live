...
import {evaluateExponentials} from './exponentials_and_logarithms_exercises';

class ex01_evaluate_exponentials extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    componentDidMount(){
        ...
        document.querySelectorAll(".topicSubHeading")[0].innerHTML = "This will ask questions on exponentials and logarithms. Click the Start button below to begin...";
    ...
    makeQuestion = () => { 
        ...
        document.getElementById("userInputBtnID").onclick = () => {checkUserInputAns(correctAns, document.getElementById("userInputStringID").value, this.question_string, "exponentials and logarithms ex01")};
...
export default ex01_evaluate_exponentials;