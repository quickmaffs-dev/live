...
class y12std_c04_ex01_soh_cah_toa extends React.Component {
    constructor(props) {
        super(props);
        this.x = 1;
        this.Ans = 1;
    ...
    findRatio = () => {        
        ...
        this.drawTriangle(opp, adj, hyp, "&#x3B8");
    ...
    findSide = () => {
        ...
        document.getElementById("questionStringID").innerHTML = questionText;
        theta += "<sup>O</sup>";
        this.drawTriangle(opp, adj, hyp, theta);
...
export default y12std_c04_ex01_soh_cah_toa;